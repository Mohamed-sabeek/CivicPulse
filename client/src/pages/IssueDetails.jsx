...
const IssueDetails = () => {
    ...
    return (
        <div className="min-h-screen lg:h-screen lg:overflow-hidden bg-gradient-to-b from-gray-50 via-white to-gray-50 flex flex-col font-sans">
            <Navbar />

            <main className="flex-1 min-h-0 pt-20 pb-4 sm:pb-5 px-4 sm:px-6 lg:px-8 flex flex-col">
                <div className="max-w-7xl w-full mx-auto flex-1 min-h-0 flex flex-col">
                    ...
                    {/* Strict Fixed-Viewport 2-Column Grid */}
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 flex-1 min-h-0 items-stretch">
                        
                        {/* ========================================================================= */}
                        {/* LEFT COLUMN: [1] Issue Evidence Image (Top) + [2] Issue Card (Bottom)    */}
                        {/* Fits completely in the viewport without page scrolling on desktop         */}
                        {/* ========================================================================= */}
                        <div className="lg:col-span-6 xl:col-span-7 flex flex-col min-h-0 h-full gap-3.5 overflow-hidden">
                            
                            {/* 1. Issue Evidence Image Box */}
                            <div className="flex-1 min-h-0 bg-white rounded-3xl p-2.5 sm:p-3 border border-gray-100 shadow-xs flex items-center justify-center overflow-hidden group">
                                <div className="w-full h-full rounded-2xl bg-slate-950 flex items-center justify-center relative overflow-hidden">
                                    {issue.imageUrl ? (
                                        <>
                                            ...
                                            />
                                            {/* Crisp, contained evidence image with zero distortion */}
                                            <img 
                                                src={issue.imageUrl} 
                                                alt={issue.title} 
                                        ...
                                        <div className="flex flex-col items-center justify-center p-6 text-center text-gray-400 space-y-2 z-10">
                                            ...
                                            <p className="text-[11px] text-gray-500 max-w-xs">This community issue has no attached photograph.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="shrink-0 bg-white rounded-3xl p-4 sm:p-5 border border-gray-100 shadow-xs space-y-3">
                                ...
                                <div>
                                    <h1 className="text-lg sm:text-xl font-black text-gray-900 tracking-tight leading-tight line-clamp-2">
                                        {issue.title}
                                    </h1>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs sm:text-sm text-gray-600 font-medium leading-relaxed max-h-20 sm:max-h-24 overflow-y-auto pr-1 custom-scrollbar whitespace-pre-line">
                                        {issue.description}
                                    </p>
                                </div>
                        ...
                        {/* ========================================================================= */}
                        {/* RIGHT COLUMN: Discussion Section Only (Independent Scrollable Container)  */}
                        {/* Only the comments area scrolls when the user scrolls on desktop           */}
                        {/* ========================================================================= */}
                        <div className="lg:col-span-6 xl:col-span-5 flex flex-col min-h-0 h-full bg-white rounded-3xl p-4 sm:p-5 border border-gray-100 shadow-xs overflow-hidden">
                            ...
                            {/* Independently Scrollable Comments List: ONLY THIS SCROLLS ON DESKTOP */}
                                    ...
                                    issue.comments.map((comment) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {/* Comment Content */}
                                                <p className="text-xs text-gray-700 font-medium leading-relaxed whitespace-pre-line pl-9.5">
                                                    {comment.text}
                                                </p>
                                            </div>
                                        );
                            ...
                            {/* Fixed Discussion Footer / Comment Input Area */}
